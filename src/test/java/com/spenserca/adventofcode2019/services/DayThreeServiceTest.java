...
class DayThreeServiceTest {
    ...
    @Test
    public void getMinimumStepsToIntersection_CalledWithInput_Returns610() {
        String wireOne = "R75,D30,R83,U83,L12,D49,R71,U7,L72";
        String wireTwo = "U62,R66,U55,R34,D71,R55,D58,R83";
        int expected = 610;

        int actual = underTest.getMinimumStepsToIntersection(Arrays.asList(wireOne, wireTwo));

        assertThat(actual).isEqualTo(expected);
    }

    @Test
    public void getMinimumStepsToIntersection_CalledWithInput_Returns410() {
        String wireOne = "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51";
        String wireTwo = "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7";
        int expected = 410;
